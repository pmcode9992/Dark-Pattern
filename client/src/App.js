    ...
    <div className="flex justify-center items-center h-screen">
      <div className="flex flex-col items-center font-mono w-full ml-3 mr-3">
        ...
        <input
          ...
          placeholder="Paste your web link"
        />
        ...
        <button
          type="button"
          className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-3 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
          onClick={currentUrl}
        >
          Current URL
        </button>
        <textarea
          id="txtComment"
          className="h-100 border ml-3 mr-3 w-full border-black"
          disabled
        ></textarea>
        {/* <markdown id="txtComment"></markdown> */}
      </div>
    </div>
  );
}
